...
def build_parser():
    p = argparse.ArgumentParser(prog="hermes_factory", description="Hermes Extraction Factory governed runtime")
    ...
    r.add_argument("--provider-timeout", type=int, default=600,
                   help="seconds the controller waits on one provider command")
