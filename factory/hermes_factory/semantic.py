...
PRIMARY_INSTRUCTIONS = (
    ...
    "infer unsupported facts. Emit uncertainty instead of guessing. All output is noncanonical."
)
...
BLIND_INSTRUCTIONS = (
    ...
    "conditionality, directionality, units and ranges. Do not infer unsupported facts."
)
